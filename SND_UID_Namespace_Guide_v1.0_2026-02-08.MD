...
|----------|------|-----------|------------------|
| **Instance 1** | `amazon-products-db-1754023596.cenq4au2o7vl.us-east-1.rds.amazonaws.com` | shopnet_connect, shopnet_sites, shopnet_assist, shopnet_data, amazon_products, KPI_Source | `sn_`, `sa_` |
