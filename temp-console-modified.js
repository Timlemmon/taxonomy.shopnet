...
function renderEndpointRegistry() {
    ...
    if (filterInfoEl) {
        if (endpointRegistryFilter !== 'all') {
            const labels = { 'W': 'Websites', 'A': 'Agents', 'D': 'Databases', 'N': 'Nodes', 'I': 'Infrastructure', 'U': 'User Devices', 'O': 'Other' };
...
// Source of truth: taxonomy_definition table in shopnet_sites DB
let TAXONOMY_LABELS = {
    'endpoint_type': { 'W': 'Website', 'A': 'Agent', 'D': 'Database', 'N': 'Node', 'I': 'Infrastructure', 'U': 'User Device', 'O': 'Other' },
...
function renderRemoveEndpointList(endpoints) {
    ...
    const typeLabels = TAXONOMY_LABELS['endpoint_type'] || {};
    const typeColors = { 'W': '#3b82f6', 'A': '#8b5cf6', 'D': '#22c55e', 'N': '#f59e0b', 'I': '#06b6d4', 'U': '#ec4899', 'O': '#6b7280' };
